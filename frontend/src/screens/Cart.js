...
const styles = StyleSheet.create({
  ...
  cartItem: { flexDirection: 'row', backgroundColor: '#121212', borderRadius: 20, padding: 15, marginBottom: 15, alignItems: 'center' },
  imageContainer: { width: 80, height: 80, backgroundColor: '#1A1A1A', borderRadius: 15, padding: 5 },
  productImg: { width: '100%', height: '100%' },
  itemDetails: { flex: 1, marginLeft: 15 },
  itemName: { color: '#FFF', fontSize: 15, fontWeight: 'bold' },
  itemFlavor: { color: '#666', fontSize: 12, marginVertical: 4 },
  priceQtyRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 5 },
  itemPrice: { color: '#FF6B00', fontSize: 16, fontWeight: 'bold' },
  qtyControls: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1A1A1A', borderRadius: 10, padding: 4 },
  qtyBtn: { padding: 5 },
  qtyText: { color: '#FFF', marginHorizontal: 10, fontWeight: 'bold' },
  removeBtn: { padding: 10, marginLeft: 5 },
  footer: { paddingHorizontal: 25, paddingTop: 20, paddingBottom: 10, backgroundColor: '#0A0A0A', borderTopWidth: 1, borderTopColor: '#1A1A1A', },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  totalLabel: { color: '#AAA', fontSize: 16 },
  totalValue: { color: '#FFF', fontSize: 24, fontWeight: 'bold' },
  checkoutBtn: { backgroundColor: '#FF6B00', padding: 20, borderRadius: 18, alignItems: 'center', shadowColor: '#FF6B00', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 10, elevation: 5 },
